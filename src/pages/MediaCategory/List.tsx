...
import { useList } from '@/modules/mediacategory/hooks';
import { IEntity } from '@/modules/mediacategory/types';
...
const List: React.FC = () => {
  ...
  return (
    <>
      <div>
        <PageHeader
          title={t('title_media_categories')}
          breadcrumb={{
            routes: [
              {
                to: '/',
          ...
          buttons={[
            <Button
              ...
              onClick={() => navigate('/media-categories/create')}
              key='create'
            />,
          ]}
        />
                  ...
                  items={[
                    {
                      ...
                      variant: 'blue',
                      onClick: () => navigate(`/departments/update/${item.id}`),
                    },
                    {
