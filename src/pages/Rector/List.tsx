...
import { useList } from '@/modules/rector/hooks';
import { IEntity } from '@/modules/rector/types';
        ...
        <PageHeader
          ...
          buttons={[
            <Button
              ...
              onClick={() => navigate('/rectors/create')}
              key='create'
            />,
          ]}
        />
                  ...
                  items={[
                    {
                      ...
                      variant: 'blue',
                      onClick: () => navigate(`/rectors/update/${item.id}`),
                    },
                    {
