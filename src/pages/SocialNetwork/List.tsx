...
import { useList } from '@/modules/socialnetwork/hooks';
import { IEntity } from '@/modules/socialnetwork/types';
                  ...
                  items={[
                    {
                      ...
                      variant: 'blue',
                      onClick: () => navigate(`/social-networks/update/${item.id}`),
                    },
                    {
